...
},{}],"/home/guzz/hipervideo/node_modules/jquery/dist/jquery.js":[function(require,module,exports){
/*!
...
},{}],"/home/guzz/hipervideo/node_modules/underscore/underscore.js":[function(require,module,exports){
//     Underscore.js 1.7.0
...
require("insert-css")("#hipVid0{background-size:cover;bottom:68px;height:auto;width:78.1%;position:fixed;right:0;transition:all .5s ease 0s;z-index:-100;opacity:0}#app.marco-fechado #hipVid0{bottom:0}");
...
},{"insert-css":"/home/guzz/hipervideo/node_modules/insert-css/index.js","jquery":"/home/guzz/hipervideo/node_modules/jquery/dist/jquery.js"}],"/home/guzz/hipervideo/vueapp/components/example.vue":[function(require,module,exports){
...
require("insert-css")(".marcos-historicos{width:100%;position:fixed;bottom:0;height:68px;box-shadow:0 0 10px #000 inset;background-color:#323232;padding:0 3%;z-index:10;transition:all .5s}#app.marco-fechado .marcos-historicos{bottom:-68px}.marcos_handle{width:15%;position:absolute;border-radius:5px;height:23px;cursor:pointer;top:-15px;background-color:#323232;left:40%}");
...
require("insert-css")("#capitulos{background-color:#323232;color:#fff;height:40px;position:relative;width:100%;z-index:1;cursor:pointer;transition:all .5s ease 0s}#video-controls.hover #capitulos{height:0}.capitulo{transition:all .2s ease 0s;height:40px;position:absolute}#video-controls.hover .capitulo{height:0}#video-controls.hover .capitulo hr{height:3px}#video-controls.hover .capitulo p{opacity:0;font-size:0}.capitulo:hover{color:#000;background-color:#c8c8c8}.capitulo hr{-moz-border-bottom-colors:none;-moz-border-left-colors:none;-moz-border-right-colors:none;-moz-border-top-colors:none;background-color:#fff;border-color:-moz-use-text-color #fff -moz-use-text-color -moz-use-text-color;border-image:none;border-style:none solid none none;border-width:medium 1px medium medium;color:#fff;float:left;height:100%;margin:0;position:absolute;top:0;width:0;transition:all .5s ease 0s}.capitulo p{margin:12px 15px;font-weight:700;font-size:80%;transition:all .5s ease 0s}");
...
require("insert-css")(".rangeslider{position:fixed;border-radius:0;top:40px;background:rgba(0,0,0,.8);transition:all .5s ease 0s}.rangeslider .rangeslider__fill{border-radius:0}.rangeslider__fill{border-radius:0;transition:all .5s ease 0s}.rangeslider__handle{width:30px;height:30px;top:0;margin-left:-11px;transition:all .5s ease 0s;z-index:11}#video-controls.hover .rangeslider__handle{width:0;height:0;opacity:0}#video-controls.hover .rangeslider__handle:after{height:0;width:0;background-color:rgba(50,50,50,.8)}.rangeslider__handle:after{height:18px;width:18px;background-color:rgba(50,50,50,.8)}#tp-cr{position:absolute;margin:7px;opacity:1;top:0;left:5px;color:#000;font-weight:700;font-size:75%;z-index:10;transition:all .5s ease 0s}#video-controls.hover #tp-cr{opacity:0;font-size:0}#tp-cr-min,#tp-cr-sec{position:relative;float:left}#tp-tt{position:absolute;margin:7px;opacity:1;top:0;right:5px;color:#fff;font-weight:700;font-size:75%;z-index:10;transition:all .5s ease 0s}#video-controls.hover #tp-tt{opacity:0;font-size:0}#tp-tt-min,#tp-tt-sec{position:relative;float:right}");
...
require("insert-css")(".btn{cursor:pointer;padding:10px;background:#ccc;display:inline-block;margin:4px}.sidebar{width:248px}.sidebar_content{position:relative;z-index:20}.sidebar_back{background-color:rgba(0,0,0,.2);width:300px;height:100%;position:absolute;top:0;left:0;transition:all .5s;transform:translate3d(-300px,0,0);z-index:10}.sidebar.is-open .sidebar_back{transform:translate3d(0,0,0)}.debug{position:absolute;width:400px;left:50%;top:40%;margin-left:-200px;text-align:center}#video-controls{position:fixed;top:0;width:100%;display:none;z-index:25}#video-controls.hover .rangeslider,#video-controls.hover .rangeslider__fill{top:0;height:3px}.titulo{position:absolute;right:0;top:0;width:70.8%;height:9.1%;font-size:200%;font-weight:700;padding-left:100px;padding-top:14px;z-index:-101}");
