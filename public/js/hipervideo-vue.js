...
require("insert-css")(".is-video-mulher .context-bg{background:red}.is-video-adolescente .context-bg{background:#0f0}.is-video-crianca .context-bg{background:#00f}.is-video-preso .context-bg{background:#00c}.is-video-deficiente .context-bg{background:#0cc}.vue-nav{position:relative;z-index:20;list-style-type:none;margin:0;padding:0}.vue-nav li{display:inline;margin:0;padding:0}.vue-nav li a{padding:10px}.vue-nav li a:hover{background:#eee}.view{transition:opacity .3s ease .3s}.view.v-enter,.view.v-leave{opacity:0}.view.v-leave{transition-delay:0}");
